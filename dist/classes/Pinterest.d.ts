export default class Pinterest {
    ...
    suggestions(id: string, bookmark?: string): Promise<import("..").SearchResults>;
    pins(query: string, bookmark?: string): Promise<import("..").SearchResults>;
    board(query: string, bookmark?: string): Promise<import("..").BoardResponse>;
}
